...
const BentoTilt = ({children, className = ""}) => {
    ...
    const handleMouseMove = (e) => {
        ...
        const {left, top, width, height} = itemRef.current.getBoundingClientRect() // This method retrieves the size and position of an element relative to the viewport.
  ...
  return (
    <section className='bg-black pb-52'>
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
            ...
            <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:">
                <BentoCard
